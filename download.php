...
<?php include ('functions.php'); 
 ...
 //Check URL Vars
	...
	if(!empty($videoData->folder_PROJECT)){

    $folder = $videoData->folder_CLIENT.'/'.$videoData->folder_PROJECT; } else {
	    
	$folder = $videoData->folder_CLIENT;
	    
    }
    
    $file_path = fileDownloadURL($filename,$folder);
